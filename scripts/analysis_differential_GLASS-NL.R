...
# needs better corrects for TA[CG]NN:
#design.glass_nl.prim_rec_qual <- model.matrix(~PC__from_OD__1 + factor(patient) + factor(pr.status), data=metadata.glass_nl.prim_rec)
design.glass_nl.prim_rec_qual <- model.matrix(~log1p(array_percentage.detP.signi) + factor(patient) + factor(pr.status), data=metadata.glass_nl.prim_rec)
...
# needs better corrects for TA[CG]NN:
# design.glass_nl.g2_vs_g3_4.quality.pp.nc <- model.matrix(~PC__from_OD__1 + factor(patient) + factor(gr.status), data=metadata.glass_nl.g2_vs_g3_4.pp.nc)
design.glass_nl.g2_vs_g3_4.quality.pp.nc <- model.matrix(~~log1p(array_percentage.detP.signi) + factor(patient) + factor(gr.status), data=metadata.glass_nl.g2_vs_g3_4.pp.nc)
...
# needs better corrects for TA[CG]NN:
#design.glass_nl.g2_3_vs_g4.quality.pp.nc <- model.matrix(~PC__from_OD__1 + factor(patient) + factor(gr.status), data=metadata.glass_nl.g2_3_vs_g4.pp.nc)
design.glass_nl.g2_3_vs_g4.quality.pp.nc <- model.matrix(~log1p(array_percentage.detP.signi) + factor(patient) + factor(gr.status), data=metadata.glass_nl.g2_3_vs_g4.pp.nc)
...
# GLASS-NL: (g2 & g3) vs. (g4) exp. corrections ----
...
saveRDS(stats.glass_nl.g2_3_vs_g4.quality.pp.nc, file="cache/analysis_differential__GLASS-NL__exp6__stats.Rds")




## exp1: PC__from_OD__1 + array_PC1 ----


design.glass_nl.g2_3_vs_g4.quality.pp.nc <- model.matrix(~PC__from_OD__1 + array_PC1 + factor(patient) + factor(gr.status), data=metadata.glass_nl.g2_3_vs_g4.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::lmFit(data.glass_nl.g2_3_vs_g4.pp.nc, design.glass_nl.g2_3_vs_g4.quality.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::eBayes(fit.glass_nl.g2_3_vs_g4.quality.pp.nc, trend=T)
stats.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::topTable(fit.glass_nl.g2_3_vs_g4.quality.pp.nc,
                                                           n=nrow(data.glass_nl.g2_3_vs_g4.pp.nc),
...
saveRDS(stats.glass_nl.g2_3_vs_g4.quality.pp.nc, file="cache/analysis_differential__GLASS-NL__exp1__stats.Rds")




## exp2: PC__from_OD__1 + array_PC4 ----


design.glass_nl.g2_3_vs_g4.quality.pp.nc <- model.matrix(~PC__from_OD__1 + array_PC4 + factor(patient) + factor(gr.status), data=metadata.glass_nl.g2_3_vs_g4.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::lmFit(data.glass_nl.g2_3_vs_g4.pp.nc, design.glass_nl.g2_3_vs_g4.quality.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::eBayes(fit.glass_nl.g2_3_vs_g4.quality.pp.nc, trend=T)
stats.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::topTable(fit.glass_nl.g2_3_vs_g4.quality.pp.nc,
                                                           n=nrow(data.glass_nl.g2_3_vs_g4.pp.nc),
...
saveRDS(stats.glass_nl.g2_3_vs_g4.quality.pp.nc, file="cache/analysis_differential__GLASS-NL__exp2__stats.Rds")
...
design.glass_nl.g2_3_vs_g4.quality.pp.nc <- model.matrix(~array_PC1 + factor(patient) + factor(gr.status), data=metadata.glass_nl.g2_3_vs_g4.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::lmFit(data.glass_nl.g2_3_vs_g4.pp.nc, design.glass_nl.g2_3_vs_g4.quality.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::eBayes(fit.glass_nl.g2_3_vs_g4.quality.pp.nc, trend=T)
stats.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::topTable(fit.glass_nl.g2_3_vs_g4.quality.pp.nc,
                                                           n=nrow(data.glass_nl.g2_3_vs_g4.pp.nc),
...
saveRDS(stats.glass_nl.g2_3_vs_g4.quality.pp.nc, file="cache/analysis_differential__GLASS-NL__exp3__stats.Rds")




# array pc2 = biological
## exp4: array_PC4 ----
...
design.glass_nl.g2_3_vs_g4.quality.pp.nc <- model.matrix(~array_PC4 + factor(patient) + factor(gr.status), data=metadata.glass_nl.g2_3_vs_g4.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::lmFit(data.glass_nl.g2_3_vs_g4.pp.nc, design.glass_nl.g2_3_vs_g4.quality.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::eBayes(fit.glass_nl.g2_3_vs_g4.quality.pp.nc, trend=T)
stats.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::topTable(fit.glass_nl.g2_3_vs_g4.quality.pp.nc,
                                                           n=nrow(data.glass_nl.g2_3_vs_g4.pp.nc),
...
saveRDS(stats.glass_nl.g2_3_vs_g4.quality.pp.nc, file="cache/analysis_differential__GLASS-NL__exp4__stats.Rds")




## exp5: array_PC1 + array_PC2 ----


design.glass_nl.g2_3_vs_g4.quality.pp.nc <- model.matrix(~array_PC1 + array_PC2 + factor(patient) + factor(gr.status), data=metadata.glass_nl.g2_3_vs_g4.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::lmFit(data.glass_nl.g2_3_vs_g4.pp.nc, design.glass_nl.g2_3_vs_g4.quality.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::eBayes(fit.glass_nl.g2_3_vs_g4.quality.pp.nc, trend=T)
stats.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::topTable(fit.glass_nl.g2_3_vs_g4.quality.pp.nc,
                                                           n=nrow(data.glass_nl.g2_3_vs_g4.pp.nc),
...
saveRDS(stats.glass_nl.g2_3_vs_g4.quality.pp.nc, file="cache/analysis_differential__GLASS-NL__exp5__stats.Rds")
...
## exp6: grade + log1p(array_percentage.detP.signi) ----
...
## exp7: grade + PC1 + log1p(array_percentage.detP.signi) ----



design.glass_nl.g2_3_vs_g4.quality.pp.nc <- model.matrix(~PC__from_OD__1 + log1p(array_percentage.detP.signi) + factor(patient) + factor(gr.status), data=metadata.glass_nl.g2_3_vs_g4.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::lmFit(data.glass_nl.g2_3_vs_g4.pp.nc, design.glass_nl.g2_3_vs_g4.quality.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::eBayes(fit.glass_nl.g2_3_vs_g4.quality.pp.nc, trend=T)
stats.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::topTable(fit.glass_nl.g2_3_vs_g4.quality.pp.nc,
                                                           n=nrow(data.glass_nl.g2_3_vs_g4.pp.nc),
...
saveRDS(stats.glass_nl.g2_3_vs_g4.quality.pp.nc, file="cache/analysis_differential__GLASS-NL__exp7__stats.Rds")
...
## exp8: grade + array_PC1 + log1p(array_percentage.detP.signi) ----



design.glass_nl.g2_3_vs_g4.quality.pp.nc <- model.matrix(~array_PC1 + log1p(array_percentage.detP.signi) + factor(patient) + factor(gr.status), data=metadata.glass_nl.g2_3_vs_g4.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::lmFit(data.glass_nl.g2_3_vs_g4.pp.nc, design.glass_nl.g2_3_vs_g4.quality.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::eBayes(fit.glass_nl.g2_3_vs_g4.quality.pp.nc, trend=T)
stats.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::topTable(fit.glass_nl.g2_3_vs_g4.quality.pp.nc,
                                                           n=nrow(data.glass_nl.g2_3_vs_g4.pp.nc),
...
saveRDS(stats.glass_nl.g2_3_vs_g4.quality.pp.nc, file="cache/analysis_differential__GLASS-NL__exp8__stats.Rds")



## exp9: grade + array_ewastools_qc_Non.polymorphic.Red ----



design.glass_nl.g2_3_vs_g4.quality.pp.nc <- model.matrix(~array_PC1 + array_ewastools_qc_Non.polymorphic.Red + factor(patient) + factor(gr.status), data=metadata.glass_nl.g2_3_vs_g4.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::lmFit(data.glass_nl.g2_3_vs_g4.pp.nc, design.glass_nl.g2_3_vs_g4.quality.pp.nc)
fit.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::eBayes(fit.glass_nl.g2_3_vs_g4.quality.pp.nc, trend=T)
stats.glass_nl.g2_3_vs_g4.quality.pp.nc <- limma::topTable(fit.glass_nl.g2_3_vs_g4.quality.pp.nc,
                                                           n=nrow(data.glass_nl.g2_3_vs_g4.pp.nc),
...
saveRDS(stats.glass_nl.g2_3_vs_g4.quality.pp.nc, file="cache/analysis_differential__GLASS-NL__exp9__stats.Rds")
...
plt <- glass_nl.metadata.array_samples |> 
  dplyr::select(array_percentage.detP.signi, paste0("array_PC",1:10)) |> 
